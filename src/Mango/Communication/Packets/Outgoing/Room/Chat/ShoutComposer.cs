...
{
    class ShoutComposer : ServerPacket
    {
        public ShoutComposer(PlayerData Player, string Text, int Emotion, int Colour)
            : base(ServerPacketHeadersNew.ShoutMessageComposer)
        {
